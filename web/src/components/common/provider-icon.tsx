      ...
      return (
        <span className={className} style={{ display: "inline-flex", width: size, height: size }}>
          <svg viewBox="0 0 24 24" width={size} height={size} fill="none">
            <path d="M12 2C12 2 14.5 8.5 17 11C19.5 13.5 22 12 22 12C22 12 19.5 14.5 17 17C14.5 19.5 12 22 12 22C12 22 9.5 19.5 7 17C4.5 14.5 2 12 2 12C2 12 4.5 13.5 7 11C9.5 8.5 12 2 12 2Z" fill="url(#gemini-grad)" />
            <defs>
    ...
    default:
      return (
        <span className={className} style={{ display: "inline-flex" }}>
          <Bot size={size} color="var(--cv4-text-secondary)" />
        </span>
      );
  }
}
